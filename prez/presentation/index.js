  ...
  render() {
    return (
      ...
      >
        ...
        <Slide
          transition={["zoom"]}
          bgImage={require("../assets/kungfu2.jpg")}
          bgSize="50%"
          bgRepeat="no-repeat"
          bgColor="primary"
        />
        ...
        >
          <List textColor="tertiary" bold>
            <Heading size={6} textColor="quaternary" caps padding="50">Jour 1</Heading>
            <ListItem textSize={60}>DEVOPS ?</ListItem>
            <ListItem textSize={60}>CI ?</ListItem>
            <ListItem textSize={60}>TP Jenkins offline</ListItem>
            <ListItem textSize={60}>Docker ?</ListItem>
          </List>
        </Slide>
        ...
        >
          <List textColor="tertiary" bold>
            <Heading size={6} textColor="quaternary" caps padding="50">Jour 2</Heading>
            <ListItem textSize={60}>Orchestrateur ?</ListItem>
            <ListItem textSize={60}>TP Kubernetes</ListItem>
            <ListItem textSize={60}>Cloud ?</ListItem>
            <ListItem textSize={60}>TP CI dans le cloud</ListItem>
          </List>
        </Slide>
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes</Heading>
          <List padding="100" textColor="tertiary" bold>
            <ListItem>Passage de pratiques artisanales à l'industrialisation de la fabrication jusqu'au déploiement logiciel et d'infrastructure</ListItem>
            <ListItem>Culture et Poste</ListItem>
            <ListItem>Fail fast</ListItem>
            <ListItem>Liens avec l'agilité</ListItem>
            <ListItem>Monitoring</ListItem>
          </List>
        </Slide>

        <Slide transition={["zoom"]} align="center flex-start" bgColor="quaternary">
          <Heading size={6} textColor="tertiary" caps padding="50">Passage de pratiques artisanales à l'industrialisation</Heading>
          <Text textSize="20" textColor="tertiary" bold>Parallèle avec industrie automobile et les chaînes de production</Text>
          <Image src={require("../assets/Volkswagen_Assembly_Line.jpg")} width="80%"/>
        </Slide>

        <Slide transition={["zoom"]} align="center flex-start" bgColor="quaternary">
          <Heading size={6} textColor="tertiary" caps padding="50">Passage de pratiques artisanales à l'industrialisation</Heading>
          <Text textSize="20" textColor="tertiary" bold>Parallèle avec transport maritime (conteneurs, plateforme multimodale), 
          avant on transportait des formats différents sans standard</Text>
          <Image src={require("../assets/playmo.jpg")} width="50%"/>
        </Slide>
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes - Culture</Heading>
          
          <List textColor="tertiary" bold padding="50">
             <ListItem textSize={32}>Automatisation</ListItem>
             <ListItem textSize={32}>Factorisation</ListItem>
             <ListItem textSize={32}>Standardisation</ListItem>
          </List>

        </Slide>

        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes - Poste</Heading>
          
          <Text textColor="tertiary" bold>du dév dans l'ops, de l'ops dans le dév</Text>

        </Slide>

        <Slide align="flex-start flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes - Marketing</Heading>
          <List textColor="tertiary" bold padding="50">
        ...
        <Slide align="flex-start flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes - Marketing</Heading>
          <List textColor="tertiary" bold padding="50">
             <ListItem textSize={32}>DevSecOps</ListItem>
          </List>
        </Slide>
        ...
        <Slide align="flex-start flex-start">
          ...
          <List textColor="tertiary" bold padding="50">
             <ListItem textSize={32}>DevSecOps</ListItem>
             <ListItem textSize={32}>DevFinOps</ListItem>
          </List>
        </Slide>
        ...
        <Slide align="flex-start flex-start">
          ...
          <List textColor="tertiary" bold padding="50">
             <ListItem textSize={32}>DevSecOps</ListItem>
             <ListItem textSize={32}>DevFinOps</ListItem>
             <ListItem textSize={32}>DevGreenOps</ListItem>
          </List>
        </Slide>
        ...
        <Slide align="flex-start flex-start">
          ...
          <List textColor="tertiary" bold padding="50">
             ...
             <ListItem textSize={32}>DevFinOps</ListItem>
             <ListItem textSize={32}>DevGreenOps</ListItem>
             <ListItem textSize={32}>DevSecFinBizOps</ListItem>
          </List>
        </Slide>

        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes - Fail fast</Heading>
          
          <List textColor="tertiary" bold padding="50">
             <ListItem textSize={32}>Embrace failure</ListItem>
             <ListItem textSize={32}>Le plus tôt possible : coût moindre</ListItem>
             <ListItem textSize={32}>Amélioration continue (// rétro agile)</ListItem>
             <ListItem textSize={32}>voire le provoquer</ListItem>
          </List>

        </Slide>

        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes - Liens avec l'agilité</Heading>
          <List padding="100" textColor="tertiary" bold>
            <ListItem>Augmenter la fréquence de déploiement : cycles courts</ListItem>
            <ListItem>Fail fast</ListItem>
        ...
        <Slide
          transition={["zoom"]}
          bgImage={require("../assets/chavire.png")}
          bgRepeat="no-repeat"
          bgSize="50%"
          bgColor="quaternary"
        >
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">DEVOPS - Principes - Monitoring</Heading>
 
          <Image src={require("../assets/hosted-grafana-synthetic-full.png")} width="50%"/>
        ...
        <Slide 
          ...
          align="center flex-start"
        >
          <Heading size={6} textColor="quaternary" caps padding="50">CI - Définition</Heading>
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">CI - Historique</Heading>
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">CI - Vocabulaire</Heading>
          ...
          <Heading size={6} textColor="primary" caps padding="50">CI - Vocabulaire</Heading>
          <Image padding="50" src={require("../assets/ICDC.png")} width="100%"/>
        </Slide>

        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">CI - Versioning (s'y retrouver)</Heading>
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          ...
          <List textColor="tertiary" bold>
            ...
            <ListItem textSize={32}>Inspection du code (métrique de qualité, de sécurité des librairies dépendantes)</ListItem>
        ...
        <Slide
          transition={["zoom"]}
          bgImage={require("../assets/ecosystem.png")}
          bgRepeat="no-repeat"
          bgSize="70%"
          bgColor="quaternary"
        >
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">Docker - Variables d'environnement</Heading>
          <Image src={require("../assets/keys.jpg")} width="80%" padding="50"/>
        </Slide>

        <Slide transition={["zoom"]} align="center flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">Docker - Variables d'environnement</Heading>
          <List textColor="tertiary" bold padding="100">
             <ListItem>12 Factor-app : Store config in the environment</ListItem>
          </List>
        </Slide>      
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          ...
          <List textColor="tertiary" bold padding="100">
             <ListItem>12 Factor-app : Store config in the environment</ListItem>
             <ListItem>Mais pas les secrets</ListItem>
          </List>
        </Slide>      
        ...
        <Slide transition={["zoom"]} align="center flex-start">
          ...
          <List textColor="tertiary" bold padding="100">
             ...
             <ListItem>Mais pas les secrets</ListItem>
             <ListItem>Mais pas les secrets</ListItem>
             <ListItem>Mais pas les secrets (ex : Vault)</ListItem>
          </List>
        </Slide> 
        ...
        <Slide align="flex-start flex-start">
          <Heading size={6} textColor="quaternary" caps padding="50">Docker - Volumes</Heading>
          <List textColor="tertiary" bold padding="50">
             <ListItem textSize={32}>Limiter la taille des images (alpine, distroless, multistage)</ListItem>
             <ListItem textSize={32}>Sécurité (option docker/orchestrateur, scan d'images par cloud provider)</ListItem>
          </List>
        </Slide>   
